...
Future<void> setupLocator() async {
  ...
  // Register ShipperRepositoryImpl
  locator.registerLazySingleton(() => ShipperService());
  locator.registerLazySingleton(() => ShipperRepositoryImpl(
        shipperService: locator<ShipperService>(),
        sharedPreferencesService: locator<SharedPreferencesService>(),
      ));
  ...
  // Register Shipper Bloc
  locator.registerLazySingleton(() => ShipperBloc(
        shipperRepository: locator<ShipperRepositoryImpl>(),
        mapRepository: locator<MapRepositoryImpl>(),
        accountBloc: locator<AccountBloc>(),
        userRepository: locator<UserRepositoryImpl>(),
        orderRepository: locator<OrderRepositoryImpl>(), webSocketService: locator<WebSocketService>(),
      ));
  ...
  locator.registerLazySingleton(() => CreateOrderProcessCubit(
        orderRepository: locator<OrderRepositoryImpl>(),
      ));
